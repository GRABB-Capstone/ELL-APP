//
//  SentenceFrameTableViewController.swift
//  ELL App
//
//  Created by Genton Mo on 2/25/16.
...
class SentenceFrameTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "sentencecell", for: indexPath) as! SentenceFrameTableViewCell
